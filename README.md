...
* 기획/운영 경험을 바탕으로 사용자 흐름을 고려한 기능 설계 가능
* 프론트엔드, 백엔드, DB, AI 모델 연동 흐름을 직접 구현
* VM 서버, SSH, DB 설치, GPU 드라이버, 배포 환경 구성 경험 보유
* 404 페이지, 예외 처리, 빈 상태 화면 등 사용자 이탈을 줄이는 UX 흐름까지 고려하여 구현
